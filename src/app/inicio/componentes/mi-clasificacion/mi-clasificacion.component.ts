...
export class MiClasificacionComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.equiposUsersService.getEquiposLigaOrdenados(this.miEquipo.idLiga).subscribe((res) => {
      ...
      this.dataSource[0].difPuntos = this.dataSource[0].puntos - this.dataSource[1].puntos;
      this.dataSource[2].difPuntos = this.dataSource[1].puntos - this.dataSource[2].puntos;
